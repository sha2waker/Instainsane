#!/bin/bash
# Coded by: ARTIMSAN (Don't change, noob!)
# www.github.com/sha2waker
# www.instagram.com/ARTIMSAN 'store; exit 1;' 2
...
printf "\n"
printf "\e[1;77m\e[41m  Instagram Brute Forcer v1.0, Author: @ARTIMSAN (Github/IG)  \e[0m\n" #Don't change, noob
printf "\n"
}
